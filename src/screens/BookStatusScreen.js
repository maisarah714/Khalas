...
export default class BookStatusScreen extends Component {
            ...
            <Container style={{backgroundColor:'#F5F5F5'}}>
                ...
                <Content padder>
                    ...
                    <Text style={{textAlign: "center", height: 100, fontFamily: "AirbnbCerealBold", fontSize: 20, margin: 50}}>
                        You got matched!
                        Tap on one of the tutors to accept or decline
                    </Text>

                    <List>
                        <ListItem>
                        <Text style={{ fontFamily: "AirbnbCerealBold"}} onPress={()=>{Actions.SessionScreen()}}>Simon Mignolet (after tap, pls put pop up card to confirm)</Text>
                        </ListItem>
                        <ListItem>
                        <Text style={{ fontFamily: "AirbnbCerealBold"}} onPress={()=>{Actions.SessionScreen()}}>Nathaniel Clyne</Text>
                        </ListItem>
                        <ListItem>
                        <Text style={{ fontFamily: "AirbnbCerealBold"}} onPress={()=>{Actions.SessionScreen()}}>Dejan Lovren</Text>
                        </ListItem>
                    </List>
                ...
                <Footer style={{height: 80}}>
                    <FooterTab style={{backgroundColor:'white'}}>
                        ...
                        <Button vertical onPress={()=>{Actions.BookStatusScreen();}}>
                            <Icon style={{color:'#F0736A', paddingBottom:7}} name="notifications-outline" size={25}/>
                            <Text style={{color:'#F0736A', fontFamily: "AirbnbCerealMedium", fontSize: 15}}>Status</Text>
                        </Button>
